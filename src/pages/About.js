    ...
    return (
        <div>
            <div className='p-20 bg-blue-900 fiftyVH flex flex-col items-center justify-center'>
                ...
                <p className='text-white w-1/2'>The club was chartered in 2004 and sits in Bida, an ancient town in the heart of Niger state, Nigeria. Every member of rotary club Bida is fully committed to helping people and we treat eachother as a family not just a club.</p>
            ...
            <div className='h-fit p-20'>
                ...
                <div className='flex flex-row justify-between items-center w-full my-11'>
                    <div className='bg-blue-900 w-5/12 p-8 rounded-2xl text-left'>
                        <h1 className='text-amber-500 font-bold uppercase text-2xl mb-1 flex items-center justify-start'><img src={transparentLogo} className='w-1/4 mr-3' />Vision statement</h1>
                        <p className='text-white'>
                            Together we see a world where people unite and take action to create lasting change - across the globe, in our communities, and in ourselves.
                        </p>
                    </div>
                    ...
                    <div className='bg-blue-900 w-2/5 p-8 rounded-2xl text-left'>
                        ...
                        <p className='text-white mb-5'>We direct our efforts to enhance our local and global impact. Our most successful and sustainable projects and activities tend to fall within the following areas:</p>
                    ...
                    <div className='bg-blue-900 w-5/12 p-8 rounded-2xl text-left'>
                        <h1 className='text-amber-500 font-bold uppercase text-2xl mb-1 flex items-center justify-start'><img src={transparentLogo} className='w-1/4 mr-3' />core values</h1>
                        <p className='text-white'>
