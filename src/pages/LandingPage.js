...
function LandingPage() {
    return (
        <>
            <div className='md:h-screen flex flex-col items-center justify-center bgHome'>
                <div className="px-10 py-10 rounded-3xl">
                    <h2 className='text-white font-thin text-3xl'>Welcome to </h2>
                    <h1 className='text-white font-semibold text-4xl md:text-7xl'>Rotary Club of Bida Central</h1>
                    <p className='text-white italic font-extralight mt-2 text-2xl md:text-5xl'>"Not just a club but a family"</p>
                    <div className='flex flex-row w-fit m-auto items-center justify-between mt-5'>
                        <Link className='text-white px-2 sm:px-4 py-3 bg-amber-500 rounded-2xl hover:text-blue-900 duration-500 mx-5 font-semibold text-sm sm:text-xl'>Projects</Link>
                        <Link to='/participate' className='text-white px-2 sm:px-4 py-3 bg-amber-500 rounded-2xl hover:text-blue-900 duration-500 mx-5 font-semibold text-sm sm:text-xl'>Participate</Link>
                    </div>
                </div>
            </div>
            <div className='h-fit flex items-center justify-center'>
                <div className=' w-3/4 h-96 my-12 bgAbout flex flex-col items-center justify-center rounded-xl'>
                    <h1 className='px-4 text-3xl sm:text-5xl text-white font-semibold uppercase'>Learn More About Rotary</h1>
            ...
            <div className='sm:fiftyVH w-screen flex flex-col sm:flex-row items-center justify-center'>
                ...
                <div className='text-left py-3 bg-cyan-200 sm:w-1/3 h-full flex flex-col items-start justify-center px-5'>
